      ...
      <div className="container px-4 mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <Link to="/" className="flex items-center gap-2">
              <span className="text-2xl font-bold text-primary">PAZZ</span>
              <span className="text-xl font-medium text-white">Partner+</span>
            </Link>
            <p className="mt-4 text-sm text-gray-400">
              La plataforma Partner+ para el mercado de leasing de vehículos.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/soporte" className="text-gray-400 hover:text-white transition-colors">
                  Soporte
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-gray-400">
            © {new Date().getFullYear()} PAZZ Partner+. Todos los derechos reservados.
          </p>
